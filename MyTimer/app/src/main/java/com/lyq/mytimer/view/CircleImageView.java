...
public class CircleImageView extends AppCompatImageView {
     ...
     * 圆角矩形
     */
    int TYPE_ROUNDED_RECT = 2;

    private int DEFAULT_TYPE = TYPE_NONE;
    private int DEFAULT_BORDER_COLOR = Color.TRANSPARENT;
    private int DEFAULT_BORDER_WIDTH = 0;
    private int DEFAULT_RECT_ROUND_RADIUS = 0;

    private int mType, mBorderColor, mBorderWidth, mRectRoundRadius;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (rawBitmap != null && mType != TYPE_NONE) {
            ...
            mMatrix.setScale((dstWidth - doubleBorderWidth) / rawBitmap.getWidth(),
                    (dstHeight - doubleBorderWidth) / rawBitmap.getHeight());
            ...
            if (mType == TYPE_CIRCLE) {
                ...
                float borderRadius = (mRectRoundRadius - halfBorderWidth > 0.0f) ?
                        mRectRoundRadius - halfBorderWidth : 0.0f;
                float bitmapRadius = (mRectRoundRadius - mBorderWidth > 0.0f) ?
