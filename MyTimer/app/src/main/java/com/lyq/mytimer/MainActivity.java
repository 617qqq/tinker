...
import com.lyq.mytimer.step.StepDemoActivity;
...
import com.lyq.mytimer.ui.StepTestActivity;
...
public class MainActivity extends BaseActivity {
	...
	private void setData() {
		...
		mData.add(new ModuleInfo(StepTestActivity.class, "StepTestActivity", "步数"));
		mData.add(new ModuleInfo(StepDemoActivity.class, "StepDemoActivity", "步数"));
